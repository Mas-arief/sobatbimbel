<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-[#1F1AA1] border-r border-[#1F1AA1] sm:translate-x-0rounded-br-[100px]"
    aria-label="Sidebar">
