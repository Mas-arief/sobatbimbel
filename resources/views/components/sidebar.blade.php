            ...
            <li>
                ...
                <div id="multi-dropdown" class="hidden z-10 bg-white divide-y divide-gray-100 rounded-lg">
                    <ul class="py-2 text-sm text-gray-700">
                        <li><a href="{{ url('profile_guru') }}" class="block px-4 py-2 hover:bg-gray-100">PROFILE GURU</a></li>
                        <li><a href="{{ url('profile_siswa') }}" class="block px-4 py-2 hover:bg-gray-100">PROFILE SISWA</a></li>
                        <li><a href="{{ url('guru_mapel') }}" class="block px-4 py-2 hover:bg-gray-100">GURU DAN MAPEL</a></li>
                    </ul>
                </div>
            </li>
        </ul>
