...
@section('content')
    ...
    <div class="flex justify-center mt-20">
        <div class="flex flex-wrap gap-10 pl-4 pr-4">
            <!-- Card Data Siswa -->
            <div class="w-64 h-64 bg-[#1F1AA1] text-white rounded-2xl flex flex-col justify-center items-center shadow-md px-4 py-6">
                ...
                <button class="bg-white text-[#1F1AA1] text-sm font-semibold px-4 py-1 rounded-md hover:bg-gray-100 transition">
                    LIHAT
                </button>
            </div>
